...
export default {
  ...
  state: {
    ...
    StoreCompare: {//店铺数据比较
      ...
      CustomerComparedOrder: "-99.55",
      CustomerSaleAmtComparedValue: "-5.00",
      CustomerSequentialOrder: "-37.84",
      EarningComparedValue: "-37.04",
      EarningPerAreaComparedValue: "-37.04",
      SaleAmtPerAreaComparedValue: "15.40",
      SaleComparedValue: "15.40",
    },
    projectRankYes: {
      YAxis: [],
      Customer: [],
