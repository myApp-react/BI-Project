                      ...
                      <div className={styles.chart_list_border + ' ' + styles.slider_four_corner_border}>
                        {
                          projectRankYes.YAxis.length === 0 ? <Empty
                            ...
                            <Recharts backgroundColor="#13153E">
                              ...
                              <Series name="会员销售" type="bar" stack="销售" data={projectRankYes.Customer} barWidth="30%" itemStyle={{"color":"#ef547d"}} />
                              <Series name="非会员销售" type="bar" stack="销售" data={projectRankYes.NoCustomer} barWidth="30%" itemStyle={{"color":"#eac057"}} />
                            </Recharts>
                        }
                      </div>
                    </div>
                      ...
                      <div className={styles.chart_list_border + ' ' + styles.slider_four_corner_border}>
                        {
                          projectRankNO.YAxis.length === 0 ? <Empty
                            ...
                            <Recharts backgroundColor="#13153E">
                              ...
                              <Series name="会员销售" type="bar" stack="销售" data={projectRankNO.Customer} barWidth="30%" itemStyle={{"color":"#33c489"}} />
                              <Series name="非会员销售" type="bar" stack="销售" data={projectRankNO.NoCustomer} barWidth="30%" itemStyle={{"color":"#03a3db"}} />
                            </Recharts>
                        }
                      </div>
                    </div>
                      ...
                      <div className={styles.chart_list_border + ' ' + styles.slider_four_corner_border}>
                        {
                          projectStore.YAxis.length === 0 ? <Empty
                            ...
                            <Recharts backgroundColor="#13153E">
                              ...
                              <Series name="销售坪效" type="bar" data={projectStore.store} barWidth="30%" itemStyle={{"color":"#ef547d"}} />
                            </Recharts>
                        }
                      </div>
                    </div>
                      ...
                      <div className={styles.chart_list_border + ' ' + styles.slider_four_corner_border}>
                        {
                          projectIncome.YAxis.length === 0 ? <Empty
                            ...
                            <Recharts backgroundColor="#13153E">
                              ...
                              <Series name="收益额" type="bar" data={projectIncome.store} barWidth="30%" itemStyle={{"color":"#ef547d"}} />
                            </Recharts>
                        }
                      </div>
                    </div>
                      ...
                      <div className={styles.chart_list_border + ' ' + styles.slider_four_corner_border}>
                        {
                          floorSalesRankYes.YAxis.length === 0 ? <Empty
                            ...
                            <Recharts backgroundColor="#13153E">
                              ...
                              <Series name="会员销售" type="bar" stack="销售" data={floorSalesRankYes.Customer} barWidth="30%" itemStyle={{"color":"#ef547d"}} />
                              <Series name="非会员销售" type="bar" stack="销售" data={floorSalesRankYes.NoCustomer} barWidth="30%" itemStyle={{"color":"#eac057"}} />
                            </Recharts>
                        }
                      </div>
                    </div>
                      ...
                      <div className={styles.chart_list_border + ' ' + styles.slider_four_corner_border}>
                        {
                          floorSalesRankNo.YAxis.length === 0 ? <Empty
                            ...
                            <Recharts backgroundColor="#13153E">
                              ...
                              <Series name="会员销售" type="bar" stack="销售" data={floorSalesRankNo.Customer} barWidth="30%" itemStyle={{"color":"#33c489"}} />
                              <Series name="非会员销售" type="bar" stack="销售" data={floorSalesRankNo.NoCustomer} barWidth="30%" itemStyle={{"color":"#03a3db"}} />
                            </Recharts>
                        }
                      </div>
                    </div>
                      ...
                      <div className={styles.chart_list_border + ' ' + styles.slider_four_corner_border}>
                        {
                          StoreSalePerAreaRankYes.YAxis.length === 0 ? <Empty
                            ...
                            <Recharts backgroundColor="#13153E">
                              ...
                              <Series name="销售坪效" type="bar" data={StoreSalePerAreaRankYes.store} barWidth="30%" itemStyle={{"color":"#ef547d"}} />
                            </Recharts>
                        }
                      </div>
                    </div>
                      ...
                      <div className={styles.chart_list_border + ' ' + styles.slider_four_corner_border}>
                        {
                          StoreEarningRankYes.YAxis.length === 0 ? <Empty
                            ...
                            <Recharts backgroundColor="#13153E">
                              ...
                              <Series name="收益" type="bar" data={StoreEarningRankYes.store} barWidth="30%" itemStyle={{"color":"#ef547d"}} />
                            </Recharts>
                        }
                      </div>
                    </div>
                      ...
                      <div className={styles.chart_list_border + ' ' + styles.slider_four_corner_border}>
                        {
                          StoreTypeFood.YAxis.length === 0 ? <Empty
                            ...
                            <Series name="会员销售" type="bar" stack="销售" data={StoreTypeFood.Customer} barWidth="30%" itemStyle={{"color":"#ef547d"}} />
                            <Series name="非会员销售" type="bar" stack="销售" data={StoreTypeFood.NoCustomer} barWidth="30%" itemStyle={{"color":"#eac057"}} />
                          </Recharts>
                        }
                      </div>
                    </div>
                      ...
                      <div className={styles.chart_list_border + ' ' + styles.slider_four_corner_border}>
                        {
                          StoreTypeFun.YAxis.length === 0 ? <Empty
                            ...
                            <Series name="会员销售" type="bar" stack="销售" data={StoreTypeFun.Customer} barWidth="30%" itemStyle={{"color":"#ef547d"}} />
                            <Series name="非会员销售" type="bar" stack="销售" data={StoreTypeFun.NoCustomer} barWidth="30%" itemStyle={{"color":"#eac057"}} />
                          </Recharts>
                        }
                      ...
                      <div className={styles.chart_list_border + ' ' + styles.slider_four_corner_border}>
                        {
                          StoreTypeRetail.YAxis.length === 0 ? <Empty
                            ...
                            <Recharts backgroundColor="#13153E">
                              ...
                              <Series name="会员销售" type="bar" stack="销售" data={StoreTypeRetail.Customer} barWidth="30%" itemStyle={{"color":"#ef547d"}} />
                              <Series name="非会员销售" type="bar" stack="销售" data={StoreTypeRetail.NoCustomer} barWidth="30%" itemStyle={{"color":"#eac057"}} />
                            </Recharts>
                        }
                      </div>
                    </div>
                      ...
                      <div className={styles.chart_list_border + ' ' + styles.slider_four_corner_border}>
                        {
                          StoreTypeMain.YAxis.length === 0 ? <Empty
                            ...
                            <Recharts backgroundColor="#13153E">
                              ...
                              <Series name="会员销售" type="bar" stack="销售" data={StoreTypeMain.Customer} barWidth={12} itemStyle={{"color":"#ef547d"}} />
                              <Series name="非会员销售" type="bar" stack="销售" data={StoreTypeMain.NoCustomer} barWidth={12} itemStyle={{"color":"#eac057"}} />
                            </Recharts>
                        }
