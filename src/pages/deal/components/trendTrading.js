    ...
    <StyledDiv>
      {
        props.BizDate.length === 0 ? <EmptyWarp>
          ...
          <Recharts
            ...
            <Series z={2} stack="销售" barMaxWidth={12} name="会员销售" barGap="-100%" type="bar"  data={props.CustSaleAmt} />
            <Series z={1} stack="销售" barMaxWidth={12} name="非会员销售" barGap="-100%" type="bar"  data={props.NoCustSaleAmt} />
          </Recharts>
      }
